          ...
          <div className="relative z-30">
            <MotionDivDownToUp className="flex justify-start desktop1:justify-start">
              <img
                ...
                className="ml-[5%] max-w-[20%] tablet1:max-w-[25%] mt-[15%] p-[10px] bg-white rounded-lg"
              />
            </MotionDivDownToUp>
                ...
                <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
                  ...
                  <div className="mt-[30%] phone3:mt-[35%] tablet1:mt-[30px] desktop1:mt-0">
                    <MotionDivDownToUp className="">
                      <div className="flex text-white justify-center desktop1:justify-start font-bold leading-[45px] phone3:leading-[50px] tablet1:leading-[65px] desktop1:leading-[63px] text-center desktop1:text-left text-title4 phone2:text-title5 phone3:text-title5 tablet1:text-title7 desktop1:text-title6 mb-[24px] [text-shadow:_2px_3px_0_rgb(0_0_0_/_50%)]">
                        {contentLp01.hero.textArea.title}
                      </div>
                    </MotionDivDownToUp>
                    <MotionDivDownToUp className="">
